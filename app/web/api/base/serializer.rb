...
module Api
    ...
    class Serializer
      ...
      # explicitly included
      def self.has_many(relationship_name, options = {}, &block) # rubocop:disable Naming/PredicateName
        super(relationship_name, options.reverse_merge(lazy_load_data: true), &block)
      end
    end
  end
end
